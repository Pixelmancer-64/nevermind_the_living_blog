...
Enfim, os arquivos csv podem ser encontrados [aqui](https://github.com/Sotiris64/WebCrawlers/tree/master/yggdrasil/Genera), você pode optar tanto pelos arquivos separados por grupo ou um único arquivo com todos os gêneros.
...
<br />
Como nos outros casos, o arquivo csv pode ser encontrado no meu [repositório](https://github.com/Sotiris64/WebCrawlers/tree/master/yggdrasil/Species)
...
Bem, o que eu tinha para mostrar aqui era isso. Esse foi um projetinho muito legal de fazer; nunca imaginaria que teria que coletar tantos dados para meu objetivo principal, [Yggdrasil Project](https://github.com/Sotiris64/YggdrasilProject). Definitivamente foi uma forma bem prática de aprender scrapy e como utilizar esses dados para contruir um banco de dados.
